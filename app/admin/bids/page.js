  ...
  const fetchBids = useCallback(
    async (page = 1) => {
      ...
      try {
        ...
        const res = await fetch(`/api/admin/bids?${queryParams}`, {
          credentials: "include",
          cache: "no-store",
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 font-inter text-sm transition-shadow"
                  />
                </div>
              </div>
