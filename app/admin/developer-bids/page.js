    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 hover:bg-gray-100"
        >
      ...
      {notification && (
        <div
          className={`fixed top-20 right-6 z-50 px-4 py-3 rounded-xl border shadow-lg flex items-center gap-3 ${notification.type === "error" ? "bg-red-50 border-red-200 text-red-700" : "bg-green-50 border-green-200 text-green-700"}`}
        >
      ...
      <div className="bg-white text-black rounded-2xl border border-gray-200 overflow-hidden mb-8 p-6">
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-900"
              />
            </div>
          </div>
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-900"
            >
                  ...
                  <tr key={bid._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      {editingBid === bid._id ? (
                        ...
                        <span
                          className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium border ${getStatusStyles(bid.status)}`}
                        >
                          {bid.status}
                        </span>
                      )}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-4 border-t border-gray-200 gap-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 rounded-xl border disabled:opacity-50 hover:bg-gray-100"
              >
                Previous
              </button>
              <span className="px-3 py-2 text-gray-600 bg-gray-50 rounded-lg">
