...
export async function GET(request, { params }) {
  try {
    ...
    console.error("GET /api/admin/developer-bids/[id] error:", error);
    return NextResponse.json(
...
export async function PUT(request, { params }) {
  try {
    ...
    console.error("PUT /api/admin/developer-bids/[id] error:", error);
    return NextResponse.json(
...
export async function DELETE(request, { params }) {
  try {
    ...
    console.error("DELETE /api/admin/developer-bids/[id] error:", error);
    return NextResponse.json(
